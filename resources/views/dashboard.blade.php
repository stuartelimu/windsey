                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="details-wrap">
                                ...
                                <div class="details-info">
                                    <p>If you would like to cancel your current subscription, you can do that here. You will still be able to access our services until the scheduled end of subscription.
                                    </p>

                                    <form action="{{ action('PlansController@destroy', $user->id) }}" method="post" class="price-button">
                                        @csrf
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="genric-btn danger-border large"  >Cancel</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="details-wrap">
                                <div class="details-info">
                                    ...
                                    <form class="form-contact contact_form" method="post" id="profileForm">
                                    @csrf
                                    <div class="row">
                                ...
                                <div class="details-info">
                                    <p>If you would like to make changes to your account, please contact <a href="#support" class="underline-hover">support.</a>
                                    </p>
                                </div>
                            </div>
                        </div>
