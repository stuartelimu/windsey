  ...
  <div class="card card-body">
    ...
    <form action="{{ action('PlansController@store') }}" method="post" >
        ...
        <div class="form-group">
            ...
            <input type="hidden" value="plan_FyGxPNsipLhdEL" class="form-control" id="exampleInputEmail1" name="plan" aria-describedby="emailHelp">
        </div>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <form action="{{ action('PlansController@store') }}" method="post" >
        @csrf
        <div class="form-group">
            <input type="hidden" value="plan_FyGy0Fv9zsAjzj" class="form-control" name="plan" aria-describedby="emailHelp">
        </div>
